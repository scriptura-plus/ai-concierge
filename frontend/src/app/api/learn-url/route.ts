...
// Вспомогательная функция для создания хэша, как в Blueprint
...
export async function POST(req: Request) {
  try {
    // 1. Получаем URL и ID клиента из запроса
    ...
    // 2. Инициализируем все наши инструменты (Адаптеры)
    ...
    // 3. Скачиваем страницу и извлекаем контент
    ...
    // 4. Сохраняем/обновляем запись о самом документе
